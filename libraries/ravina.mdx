...
Tracks request capacity available to a resource. Intended to be used with [Calls](#remote-call) to potentially wait until
...
Sorts by error count and then sample call time.
