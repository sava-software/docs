...
title: "KMS Clients"
sidebarTitle: "KMS"
description: "KMS clients for the purpose of isolating private key signing."
mode: "wide"
---
...
via a SigningServiceFactory implementation.
...
Direct configuration of secret information.
...
See [sava core private key parsing](/libraries/core#private-key-pair-parsing) for all supported encodings.
...
Unfortunately they do not provide HSMs for ed25519,
and also their libraries have a large amount dependencies.
